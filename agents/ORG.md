...
| slurry-abrasive | 활성 (G2 개방 2026-09-09) | 3/6 (Lv2-1 완성: 입자경도·Hertz소성압입·제거체적, Luo-Dornfeld H_w^-3/2 재현, 실리카경도<SiO2벌크경도 발견→수화층모델 정량뒷받침, 벌크경도법칙 단독예측과 실측 62배 불일치→화학지배 재확인) | 2026-09-11 |
