...
│   │   │   └─ slurry-colloid              [활성, G3 2026-09-12]  분산 안정성·응집·POU 필터·쉘프라이프
...
│   │   └─ tool-post-clean                 [활성, G4 2026-09-13]  Post-CMP 세정·브러시·결함
│   │
│   ├─ 물리 (Physics) — 횡단
│   │   ├─ tribologist ★                   [활성]  마찰·윤활·유동·열
│   │   └─ defect-scientist                [활성, G3 2026-09-12]  스크래치·잔류입자·부식·디싱 원인 분석
│   │
...
| wafer-type | 활성 (G1 개방 2026-09-06) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-19: NPW/PTW 메타데이터 스키마·정렬 규칙 — 300mm·26×33mm 합성격자 57 완전다이, 외곽 21.8% 면적 NPW-only 비교불가, 다이 반경스팬 42mm > 81점 링간격 29.4mm, local_density 결손=비교금지, 두 스키마 모두 wafer_type 키 부재 발견) | 2026-09-19 |
| surface-contamination | 활성 (G1) | 6/6 ✓ 완주 (Cal-1은 G2 대기) | 2026-09-09 |
| pad-material | 활성 (G2 개방 2026-09-06) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-20: 스펙시트→GW 입력 매핑 — Shore D 60에 Qi eq.11 117 MPa vs Kunz-Studer 6.99 MPa 17배 갈림→경도로 E* 고정 불가, E*는 Lv3-2 문헌 클러스터 prior; (E*,η) 곱구조 단일조건·압력스윕 모두 비식별, E* 고정 시만 η 식별; 레지스트리 P12~P14; 새 특허 US10562149B2·US20030100250A1) | 2026-09-20 |
...
| film-oxide | 활성 (G1 개방 2026-09-08) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-19: 옥사이드 실데이터 14필드 스키마, Kp=Kp_ref·m_f·P·V 분해 — 배율 prior 고정·절대 Kp_ref 피팅, thermal 앵커 없으면 조건수 ∞·상관 −1(비식별)/앵커 시 조건수≈14, 선택비는 P·V 매칭 필수, prior σ_log=ln1.5) (Lv3-2 완료: 막질별 Kp 배율 thermal=1 기준 TEOS 1.35·HDP/SOD 1.30~1.50·PSG 2.9·BPSG 4.6(Liu 1995 앵커, 상대비 literature·절대 Kp estimated), 세리아는 경도→밀도/화학 축이라 배율 이식 금지) | 2026-09-19 |
| film-cu | 활성 (G1 개방 2026-09-08) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-20: Cu NPW/PTW 실데이터 필드 근거 Park 1999·Tugbawa 2002·US7300602B2; 파라미터 분해 스케일 B·τ₃·Y₁=피팅/형상지수·선택비=prior 고정; Tugbawa 선폭스윕 재현 오차 5.3%·밀도 Y₁ 4.8%; 오버폴리시 시간스윕 없으면 (d_max,τ₃) 조건수 4.3e10·상관 0.999 비식별, 과도영역 스윕 시 4.9e3 식별) | 2026-09-20 |
| slurry-abrasive | 활성 (G2 개방 2026-09-09) | 6/6 + Cal-1 완료(2026-09-19: 스펙시트→팩 입력 변환 3규칙 — Hatch-Choate median 변환(disc centrifuge D99/D50→σg=1.31, D75 3.6% 교차검증)·wt%→vol%·1차입경 vs 응집체, TDS Z-avg(강도) vs 특허 질량가중 불일치, 팩 50nm size_basis 부재로 최대 35% 잠재편차, Kp 곱구조 단일조건 비식별→스윕 필요) (Lv3-2 완료: 입자 파라미터→Kp 정량모델 — 농도항 US9499721B2 E1 재현(멱함수 SSE 926 vs 포아송 포화 135, ΔAIC>10 포화형 우세), 입경 정점 실리카 80/세리아 163 레짐분할, 입자경도는 κ 승수가 아니라 리지드 인덴터 게이트, D99→Δ 귀속, 알루미나 배율 미확보) | 2026-09-19 |
| slurry-chemistry | 활성 (G2 개방 2026-09-09) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-20: COA/스펙→χ 상수 매핑, POU 작동 pH≠원액 pH(Bae 2023: 10→9.78, +0.2 pH가 MRR ≈30%) → `measured_ph_pou` 없으면 χ_pH PriorExcluded; Miranda 2004 2×2로 pH 단독 스윕 기울기 부호전환(1.0 vol% +0.120 / 3.5 vol% −0.621) 확인, 2×2는 cond 1.0 식별; ψ K는 PriorExcluded 판정; 레지스트리 C1~C9) | 2026-09-20 |
| film-w | 활성 (G2 개방 2026-09-09) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-20: W NPW/PTW/슬러리 실데이터 필드 근거 Choi 2022·Xu 2016, Kp_W=Kp_ref·f_ox(C;K_ox,φ)·g_pH — Kp_ref·K_ox 피팅/φ·곡선형 prior, K_ox 산화제 종류별 재설정; H2O2/Fe(NO3)3 스윕 재현 오차<3%·반포화 1600배; 포화영역 미포함 시 (Kp_ref,C_peak) |r|=0.9998 비식별; 팩 Kp 2.6배는 s≈0.39로 흡수 가능·산화제 100배는 `oxidizer_type` 필드 없이는 불가; 레지스트리 W1~W6) | 2026-09-20 |
| cmp-data-engineer | 활성 (G2 개방 2026-09-09) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-20: 직전 Cal-1 4편 제안 통합 → record 49필드, JSON Schema 2020-12 if/then·dependentRequired·RFC3339 근거, 표준라이브러리 검증기로 합성 6레코드 정상3/위반3 분기, SemVer optional=MINOR/required=MAJOR 마이그레이션 규칙) | 2026-09-20 |
...
| cmp-calibrator | 활성 (G3 개방 2026-09-16, 선수충족) | 6/6 ✓ 완주 + Cal-1 완료(2026-09-20: 보정 파라미터 레지스트리 — 곱셈구조 3레짐 식별성 단일조건 cond=∞ → P·V스윕 Kp_ref만 → +막·입경스윕 전부 복원 cond<1e7; Tuo&Wu·Le Gratiet 2014 순차 co-kriging 근거; 5단계 피팅 절차 ↔ sim/calibration 매핑, 미구현 3건 적시) | 2026-09-20 |
| (그 외) | 대기 | — | — |
