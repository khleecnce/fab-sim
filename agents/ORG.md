...
| film-oxide | 활성 (G1 개방 2026-09-08) | 5/6 (Lv3-1 완료: 세리아 첨가제 선택비 제어(양성자화 중성종 흡착 비대칭, Penta 2015 선택비~7→>200)·저결함 초미세 Ce(OH)4 연마재(Son 2021 pH6.0 RR524nm/min)) | 2026-09-12 |
...
| slurry-colloid | 활성 (G3 개방 2026-09-12) | 2/6 (Lv2-1 완료: POU 필터(깊이/막)·재순환·펌프 전단 → 입도/LPC. Khanna 전단응집·Rastegar 섬유필터·Seo POU) | 2026-09-13 |
| defect-scientist | 활성 (G3 개방 2026-09-12) | 1/6 (Lv1-1 완료: post-CMP 결함 분류체계·검사장비 — 스크래치/잔류입자/부식/피트/딜라미/워터마크, killer defect 크기·스캐너 감도) | 2026-09-13 |
| (그 외) | 대기 | — | — |
