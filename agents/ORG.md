...
| slurry-abrasive | 활성 (G2 개방 2026-09-09) | 2.0/6 (Lv1-2 완료, Lv2-1 부분: 세리아(sti_ceria/sic_ceria_h2o2) D99=700nm+n=1.44 배선 완료, delta 팩터 첫 발동. 알루미나(cu_h2o2_bta/w_fe_oxidizer)·oxide_silica는 여전히 D99 미확보) | 2026-09-10 |
| slurry-chemistry | 활성 (G2 개방 2026-09-09) | 3/6 (Lv1-1 산화제, Lv1-2 억제제·킬레이트, Lv2-1 pH·이온강도→ζ·용해율·선택비 완료) | 2026-09-11 |
| film-w | 활성 (G2 개방 2026-09-09) | 3/6 (Lv2-1 완료: 플러그 리세스/코어링/키홀·심(seam) 발생·CMP 확대·산화막버프 공정창(Yu2009 E_f=E_i−mL, P=nL−R)·키홀 EM수명 1.9배(Kim2005)) | 2026-09-11 |
| cmp-data-engineer | 활성 (G2 개방 2026-09-09) | 3/6 (Lv2-1 완료: SEMI M20 좌표계·극좌표/다이인덱스 정규화·단위통일(psi/Å/rpm)·MAD 이상치·FQA 엣지제외, 노치오등록 스칼라불변성 uniformity.py 대조) | 2026-09-11 |
| film-nitride | 활성 (G3 개방 2026-09-09) | 3/6 (Lv2-1 완료: STI 나이트라이드 침식 E(t)·손실예산(200Å)→오버폴리시 창, K_ss=K/(1+ρ(s−1)), 블랭킷선택비≠패턴손실(s_eff≈3), 자기정지 포화 대조) | 2026-09-11 |
| film-poly-si | 활성 (G3 개방 2026-09-10) | 2/6 (Lv1-2 완료: 알칼리 화학 용해·pH 의존성) | 2026-09-11 |
| tool-endpoint | 활성 (G3 개방 2026-09-10) | 3/6 (Lv2-1 완료: 막질별 EPD 적합성·투명막/다층 한계) | 2026-09-11 |
| (그 외) | 대기 | — | — |
