# 커리큘럼 — 슬러리 화학자 (Slurry Chemist)

> 규칙: 순서대로 학습. 단원마다 ①출처 있는 지식노트(knowledge/) ②자기시험 3문항+답(EXAMS.md) ③가능하면 수식의 코드 재현.

- [x] Lv1-1 콜로이드 화학 기초: 제타전위, DLVO 이론, 입자 안정성 <!-- 이수 2026-09-05 -->
- [x] Lv1-2 CMP 슬러리 구성요소 총론: 입자/산화제/억제제/분산제 역할 <!-- 이수 2026-09-05 -->
...
- [x] Lv2 부록 — ψ 흡착보호 병목 3상수(K/n/k) 1차 출처 재대조, Hill n 반증 시도 <!-- 이수 2026-09-15, knowledge/cmp/psi-shield-hill-constants-ceria-primary-source.md -->
