...
- [x] Lv3-1 최신 리뷰: CVD 다이아 디스크, 패턴화 그릿 배열 (2026-09-08, knowledge/equipment/cvd-diamond-disk-patterned-grit-array.md)
- [x] Lv3-2 디스크 파라미터 → 절삭율·asperity 재생 모델 (2026-09-08, knowledge/materials/disk-design-cutrate-asperity-regeneration-model.md)
